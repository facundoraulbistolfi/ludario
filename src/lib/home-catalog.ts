...
export const CATALOG_ITEMS: CatalogItem[] = [
  ...
  },
  {
    ...
    icon: '🧠',
    tags: ['Juego'],
    chips: ['2 jugadores', 'Memoria', 'Un celular'],
    title: 'Memo Duelo',
    subtitle: 'Encontrá parejas y disputá cada punto pasándose un solo celular.',
    description: 'Duelo de memoria para dos personas, con turnos automáticos, puntuación y una pantalla de entrega del teléfono.',
    collection: 'arcade',
    coverStyle: 'neon',
    accent: '#6b8cff',
    shelfLabel: 'Duelo',
  ...
  {
    id: '/tools/veintiuno-secreto',
    kind: 'internal',
    to: '/tools/veintiuno-secreto',
    icon: '♠️',
    tags: ['Juego', 'Cartas'],
    chips: ['2 jugadores', 'Riesgo', 'Un celular'],
    title: 'Veintiuno Secreto',
    subtitle: 'Pedí, plantate y administrá el riesgo sin revelar tu mano.',
    description: 'Duelo privado de cartas tipo 21 para dos personas, diseñado para jugar por turnos en el mismo teléfono.',
    collection: 'criollo',
    coverStyle: 'filigree',
    accent: '#d6a84b',
    shelfLabel: 'Naipes',
  ...
  {
    id: '/tools/codigo-rival',
    kind: 'internal',
    to: '/tools/codigo-rival',
    icon: '🔐',
    tags: ['Juego'],
    chips: ['2 jugadores', 'Deducción', 'Código secreto'],
    title: 'Código Rival',
    subtitle: 'Descifrá una clave de colores usando pistas exactas y parciales.',
    description: 'Juego de deducción lógica: cada persona crea una clave secreta y el rival intenta resolverla en ocho intentos.',
    collection: 'casefile',
    coverStyle: 'stamped',
    accent: '#cf5f91',
    shelfLabel: 'Deducción',
  },
  {
    id: '/tools/hegemonia',
    kind: 'internal',
    ...
    icon: '🏛️',
    tags: ['Juego'],
    chips: ['2 jugadores', 'Estrategia', 'Civilizaciones'],
    title: 'Hegemonía',
    subtitle: 'Construí una civilización durante tres eras y elegí cómo dominar.',
    description: 'Duelo estratégico con mercado compartido, economía, espionaje y tres rutas de victoria: cultura, guerra o ciencia.',
    collection: 'study',
    coverStyle: 'plate',
    accent: '#c69b49',
    shelfLabel: 'Estrategia',
  },
  {
    id: '/tools/nexo',
    kind: 'internal',
    ...
    icon: '⬡',
    tags: ['Juego'],
    chips: ['2 jugadores', 'Estrategia', 'Cero azar'],
    title: 'Nexo',
    subtitle: 'Conectá tus extremos en un tablero de información total y azar cero.',
    description: 'Duelo abstracto de conexión con tableros 7×7, 9×9 y 11×11, ruta mínima y regla de intercambio.',
    collection: 'laboratory',
    coverStyle: 'stamped',
    accent: '#1559d6',
    shelfLabel: 'Abstracto',
  },
  {
    ...
    chips: ['2–6 jugadores', 'Táctil'],
    title: 'Contador de Puntos',
    subtitle: 'Sumá, restá y editá puntajes con controles táctiles grandes.',
    description: 'Marcador configurable para 2 a 6 jugadores, con colores, sumas rápidas, edición manual y guardado automático.',
    collection: 'ledger',
    coverStyle: 'ledger',
    accent: '#68c7a6',
    shelfLabel: 'Mesa',
